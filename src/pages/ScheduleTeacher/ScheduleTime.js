...
export default function ScheduleTime() {
  ...
  const childCareId = searchParams.get("childCareId");

  // const [selectedDay, setSelectedDay] = useState(null);
  // const [selectedClass, setSelectedClass] = useState(null);
  const storedScreens = JSON.parse(sessionStorage.getItem("screens") || "{}");
  // console.log(childCareId,id);
                                ...
                                {[...Array(maxStudents)].map((_, rowIndex) => (
                                  <tr key={rowIndex}>
                                    {batchTimes.map((time, timeIndex) => {
                                      ...
                                      const student =
                                        matchingBatch?.children.length >
                                        rowIndex
                                          ? matchingBatch.children[rowIndex]
                                          : null;
                                      ...
                                      // console.log("student",matchingBatch)
