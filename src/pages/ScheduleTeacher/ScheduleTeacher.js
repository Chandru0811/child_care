...
import ScheduleTeacherEdit from "./ScheduleTeacherEdit";
...
const ScheduleTeacher = () => {
  ...
  const handelDelete = async (rowData) => {
    try {
      const { childrenId, userId, courseId, classId, days } = rowData;
      const formData = new FormData();
      formData.append("childrenId", childrenId);
          ...
          {loading ? (
            ...
            <>
              <div className=" d-flex  justify-content-between px-4">
                ...
                <div>
                {storedScreens?.scheduleTeacherCreate && (
                        ...
                        />
                         ...
                         {storedScreens?.scheduleTeacherDelete && ( 
                            ...
                            {storedScreens?.timeScheduleIndex && ( 
                              <Link
                                to={`/scheduleteacher/scheduletime/${data.userId}?childCareId=${data.childrenId}`}
                              >
